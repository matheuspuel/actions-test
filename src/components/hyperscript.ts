...
import { UIElementInput } from './types'
...
export type UIComponent1 = AnySingleArgFunction<UIElementInput>
...
const toUnderlying1 =
  ...
  args =>
    elementFromInput(component(args[0]))

const toUnderlying2 =
  <C extends UIComponent2>(component: C): UIUnderlyingComponent2<C> =>
  args =>
    elementFromInput(component(args[0])(args[1]))

const toUnderlying3 =
  <C extends UIComponent3>(component: C): UIUnderlyingComponent3<C> =>
  args =>
    elementFromInput(component(args[0])(args[1])(args[2]))
...
export const namedConst =
  (name: string) =>
  (component: () => UIElementInput): UIElementInput =>

...
import { UIColor, UIElement, UIElementInput } from 'src/components/types'
...
export type ImageProps = ImageStyleProps & {
  ...
  alt?: string
  tintColor?: UIColor
  Loading?: UIElementInput
  Error?: UIElementInput
}

type ImageStatus = 'loading' | 'success' | 'error'

export const Image = named('Image')((props: ImageProps): UIElement => {
